# raxml package README

This directoy contains the build files for the raxml package, which is part
of the raxml roll. Unique to the raxml roll/package is the bundled 
