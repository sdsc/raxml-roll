# garli package README

This directoy contains the build files for the garli package, which is part
of the garli roll. Unique to the garli roll/package is the bundled 
